...
from  qqZone.io_in_out import *
import random
from qqZone import qzone_login
...
class QzonePhotoManager(object):
    ...
    def __init__(self, user, password):
        ...
        driver = webdriver.Chrome(r"C:\Users\FBY\AppData\Local\Programs\Python\Python36\chromedriver.exe")
        # 使用 get() 方法打开待抓取的 URL
        ...
        if a == True:
            ...
            driver.find_element_by_id('u').send_keys('3257490363')
            driver.find_element_by_id('p').clear()
            driver.find_element_by_id('p').send_keys('iLU022627!')
...
def entry():
    # 你的 QQ
    main_user = '3257490363'
    main_pass = 'iLU022627!'

    # 要处理的目标 QQ 号
    dest_users = ['1992783851']
